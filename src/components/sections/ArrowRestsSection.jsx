// src/components/sections/ArrowRestsSection.jsx
...
const ArrowRestsSection = () => {
  const arrowRests = [
    { ...productData[5], description: "SIMPLICITY GUARANTEED." },
    { ...productData[6], description: "PERFECTION JUSTIFIED." },
  ];
...
export default ArrowRestsSection;
