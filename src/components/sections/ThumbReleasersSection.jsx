// src/components/sections/ThumbReleasersSection.jsx
...
const ThumbReleasersSection = () => {
  const releasers = [
    { ...productData[3], description: "START RIGHT!" },
    { ...productData[4], description: "RELEASE REFINED!" },
  ];
    ...
    <section className="bg-white py-12 md:py-16 lg:py-20">
      ...
      >
        {releasers.map((releaser) => (
          ...
          >
            <Link to={`/products/${releaser.route}`}>
              {/* The aspect-[4/3] provides a great, consistent shape */}
              ...
              <div className="absolute inset-0 bg-black/40 group-hover:bg-black/20 transition-all duration-500 flex flex-col justify-end p-6 sm:p-8 lg:p-12">
                ...
                <div className="self-start px-6 py-3 border-2 border-white text-white hover:bg-white hover:text-black transition-all duration-300 rounded-lg font-bold uppercase tracking-widest text-sm transform hover:scale-110">
                  EXPLORE
                </div>
              </div>
            </Link>
...
export default ThumbReleasersSection;